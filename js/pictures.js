...
var Upload = {
    ...
    renderUploadOverlay: function () {
        ...
        var resetFilterControls = function () {
            ...
            var standartEffectLevel = 60; // in percentages

            filterLevelPin.style.left = standartEffectLevel.toString() + "%";
            filterLevelValue.style.width = standartEffectLevel.toString() + "%";
        }
        ...
        var setFilterControll = function () {
            ...
            var applyFilter = function () {
                ...
                var pinStringValue = overlay.querySelector(".upload-effect-level-pin");
                var pinValue = Number(pinStringValue.style.left.slice(0, -1));
            ...
            var movePin = function (evt) {
                var allLine = document.querySelector(".upload-effect-level-line");
                var pinLevel = overlay.querySelector(".upload-effect-level-pin");
                var lineLevel = overlay.querySelector(".upload-effect-level-val");
                ...
                pinLevel.style.left = pinValue.toString() + "%";
                lineLevel.style.width = pinValue.toString() + "%";

                applyFilter();
            }

            levelLine.addEventListener("click", movePin);
        }
